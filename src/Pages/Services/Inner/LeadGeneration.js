...
import g1 from "../../../assets/images/services/inner/lead-gen.jpg";
            ...
            <section className="page__title p_relative bgOverlay">
                ...
                <div className="auto-container">
                    <div className="content__box p_relative">
                        ...
                        <h1 className="title">Lead Generation</h1>
                    </div>
                </div>
            </section>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="about__text__block">
                                <div className="sub__title">
                                    <h4>LEAD GENERATION EXCELLENCE</h4>
                                </div>
                                <div className="title two">
                                    <h2>
                                        Turning <span>Prospects</span> into Profit
                                    </h2>
                                </div>
                                <div className="texts">
                                    <p>
                                        With a track record of successful lead generation campaigns and satisfied clients, we have the expertise and resources to help you achieve your business goals. Whether you're a startup or an established enterprise, you can trust us to deliver results that exceed your expectations. Let's fuel your business growth and drive your success forward together.
                                    </p>
                                </div>
                ...
                <div className="auto-container">
                    <div className="row">
                        <div className="col-lg-4 col-md-12">
                            ...
                            <div className="title two">
                                <h2>
                                    Where <span>Leads</span> Flow, Success Follows
                                </h2>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="normaol__text">
                                <p>In the digital age, generating high-quality leads is the lifeblood of any business. At Outsource to Asia, we understand the importance of connecting with your target audience and converting them into loyal customers. That's why we offer comprehensive Lead Generation services designed to help you attract, engage, and convert leads at every stage of the customer journey.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <Accordion activeKey={activeAccordion} onSelect={handleAccordionChange}>
                                    <Accordion.Item eventKey="1">
                                        <Accordion.Header>
                                            ...
                                            Targeted Outreach</Accordion.Header>
                                        <Accordion.Body>
                                            We'll identify your ideal customer profile and develop targeted outreach strategies to reach them where they are. Whether it's through email campaigns, social media ads, or targeted content, we'll ensure that your message resonates with the right audience and drives action.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="2">
                                        <Accordion.Header>
                                            ...
                                            Content Marketing</Accordion.Header>
                                        <Accordion.Body>
                                            Content is king when it comes to lead generation. Our team of content creators will develop high-quality, relevant content that attracts and engages your target audience. From blog posts and ebooks to webinars and videos, we'll create content that educates, inspires, and converts.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="3">
                                        <Accordion.Header>
                                            ...
                                            Conversion Optimization</Accordion.Header>
                                        <Accordion.Body>
                                            We'll optimize your website and landing pages to maximize conversions and capture leads effectively. Whether it's through A/B testing, user experience improvements, or persuasive copywriting, we'll ensure that every visitor to your site has a clear path to conversion.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="4">
                                        <Accordion.Header>
                                            ...
                                            Marketing Automation</Accordion.Header>
                                        <Accordion.Body>
                                            Streamline your lead generation efforts with marketing automation. We'll set up automated workflows to nurture leads through the sales funnel, delivering targeted content and messages that move them closer to conversion. From welcome emails to abandoned cart reminders, we'll ensure that no lead falls through the cracks.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="5">
                                        <Accordion.Header>
                                            ...
                                            Analytics and Reporting</Accordion.Header>
                                        <Accordion.Body>
                                            We'll provide you with detailed analytics and reporting to track the performance of your lead generation efforts and measure the ROI of your campaigns. Our reports will help you understand which channels and tactics are driving results, so you can make data-driven decisions and optimize your strategy for maximum impact.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                </Accordion>
                            </div>
            ...
            <div className="pride__section  p_relative see__pad">
                ...
                <div className="auto-container">
                    <div className="pride__block">
                        <h1>Convert Clicks into Customers with Our Lead Generation Magic</h1>
                        <p className='mt-20'> Fuel your business growth with our lead generation solutions! Convert leads into customers, success into reality.</p>
                        <div className="btn-box mt-50 mx-auto justify-content-center">
                            <Link to="/about" className="theme-btn theme-btn-one">
                                <i className="icon-02"></i> Let's Build Your Pipeline Together
                            </Link>
                        </div>
                    </div>
                </div>
