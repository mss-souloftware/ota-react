...
import g1 from "../../../assets/images/services/inner/digital-marketing.jpg";
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12">
                            <div className="about__text__block">
                                ...
                                <div className="texts">
                                    <p>
                                        Our digital marketing services are fueled by cutting-edge analytics and insights, ensuring that every decision is backed by data to maximize your ROI and drive sustainable growth. We understand that every business is different. That's why we take a personalized approach to digital marketing, crafting customized strategies that align with your goals, target audience, and industry landscape.
                                    </p>
                                </div>
                ...
                <div className="auto-container">
                    <div className="row">
                        <div className="col-lg-4 col-md-12">
                            ...
                            <div className="title two">
                                <h2>
                                    From Clicks to <span>Conversions</span>, We've Got You Covere
                                </h2>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="normaol__text">
                                <p>In today's fast-paced digital landscape, having a strong online presence is essential for success. That's where our Digital Marketing services come in. Our team of experienced marketers specializes in crafting data-driven strategies that drive results and help businesses thrive in the digital age.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className='serviceAccr'>
                                <Accordion activeKey={activeAccordion} onSelect={handleAccordionChange}>
                                    <Accordion.Item eventKey="1">
                                        ...
                                        <Accordion.Body>
                                            Increase your visibility and drive organic traffic to your website with our SEO services. From keyword research and on-page optimization to content creation and link building, we'll help you climb the search engine rankings and attract more potential customers.
                                    ...
                                    <Accordion.Item eventKey="2">
                                        ...
                                        <Accordion.Body>
                                            Get instant visibility and drive targeted traffic to your website with our PPC advertising services. Whether you're looking to run ads on Google, Facebook, or another platform, we'll develop a customized strategy that maximizes your ROI and achieves your business goals.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="3">
                                        <Accordion.Header>
                                            ...
                                            Social Media Marketing</Accordion.Header>
                                        <Accordion.Body>
                                            Engage with your audience and build brand awareness with our social media marketing services. From creating compelling content to managing ad campaigns and analyzing performance, we'll help you leverage the power of social media to grow your business and connect with your customers.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="4">
                                        ...
                                        <Accordion.Body>
                                            Fuel your digital strategy with compelling content that resonates with your audience. Whether it's blog posts, articles, videos, or infographics, our team of content creators will help you tell your brand story in a way that captivates and inspires.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="5">
                                        ...
                                        <Accordion.Body>
                                            Nurture leads and drive conversions with our email marketing services. From creating targeted email campaigns to optimizing deliverability and tracking performance, we'll help you build and maintain meaningful relationships with your customers.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="5">
                                        <Accordion.Header>
                                    ...
                                    <Accordion.Item eventKey="6">
                                        ...
                                        <Accordion.Body>
                                            Measure the effectiveness of your digital marketing efforts with our analytics and reporting services. We'll provide you with actionable insights and data-driven recommendations to help you make informed decisions and optimize your marketing strategy for maximum impact.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                </Accordion>
                            </div>
            ...
            <div className="pride__section  p_relative see__pad">
                ...
                <div className="auto-container">
                    <div className="pride__block">
                        <h1>Fuel Your Growth Engine with Our Digital Strategies</h1>
                        <p className='mt-20'>Supercharge your online presence with our digital marketing expertise. Drive traffic,  increase engagement, and maximize conversions.</p>
                        <div className="btn-box mt-50 mx-auto justify-content-center">
                            <Link to="/about" className="theme-btn theme-btn-one">
                                <i className="icon-02"></i> Let's Elevate Your Brand's Digital Impact Together
                            </Link>
                        </div>
                    </div>
                </div>
