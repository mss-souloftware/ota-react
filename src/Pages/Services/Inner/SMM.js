...
import g1 from "../../../assets/images/services/inner/smm.jpg";
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="about__text__block">
                                <div className="sub__title">
                                    <h4>ENGAGE, CONVERT, SUCCEED</h4>
                                </div>
                                <div className="title two">
                                    <h2>
                                        Social Media <span>Done Right!</span>
                                    </h2>
                                </div>
                                <div className="texts">
                                    <p>
                                        Whether you're a small business looking to build brand awareness or a multinational corporation seeking to engage with customers on a global scale, Outsource to Asia has the expertise and resources to help you achieve your social media goals. Partner with us today and let's take your social media presence to the next level.
                                    </p>
                                </div>
                ...
                <div className="auto-container">
                    <div className="row">
                        <div className="col-lg-4 col-md-12">
                            ...
                            <div className="title two">
                                <h2>
                                    Navigate the <span>Social</span> Sphere with Confidence
                                </h2>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="normaol__text">
                                <p>In today's digital world, social media has become a cornerstone of marketing strategy. However, managing multiple social media platforms effectively can be time-consuming and challenging. That's where our Social Media Management services come in. Our team of experienced social media experts is here to help you build and maintain a strong and engaging presence on social media, so you can focus on what you do best – running your business.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <Accordion activeKey={activeAccordion} onSelect={handleAccordionChange}>
                                    <Accordion.Item eventKey="1">
                                        <Accordion.Header>
                                            ...
                                            Strategy Development</Accordion.Header>
                                        <Accordion.Body>
                                            We'll work with you to develop a comprehensive social media strategy tailored to your unique business goals and target audience. Whether you're looking to increase brand awareness, drive website traffic, or generate leads, we'll develop a strategy that aligns with your objectives and delivers results.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="2">
                                        <Accordion.Header>
                                            ...
                                            Content Creation</Accordion.Header>
                                        <Accordion.Body>
                                            Our team will create high-quality, engaging content that resonates with your audience and showcases your brand's personality. From eye-catching graphics and captivating videos to informative blog posts and shareable memes, we'll create content that sparks conversation and drives engagement.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="3">
                                        <Accordion.Header>
                                            ...
                                            Community Management</Accordion.Header>
                                        <Accordion.Body>
                                            Building and nurturing relationships with your audience is key to social media success. Our community management services include responding to comments and messages, engaging with followers, and fostering meaningful conversations that help strengthen your brand's connection with your audience.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="4">
                                        <Accordion.Header>
                                            ...
                                            Paid Advertising</Accordion.Header>
                                        <Accordion.Body>
                                            Amplify your social media presence and reach new audiences with our paid advertising services. Whether you're running ads on Facebook, Instagram, LinkedIn, or Twitter, we'll develop targeted campaigns that drive results and maximize your return on investment.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="5">
                                        <Accordion.Header>
                                            ...
                                            Analytics & Reporting</Accordion.Header>
                                        <Accordion.Body>
                                            We'll provide you with detailed analytics and reporting to track the performance of your social media campaigns and measure the impact of our efforts. Our reports will help you understand what's working, what's not, and where there's room for improvement, so you can make informed decisions and optimize your strategy for maximum results.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                </Accordion>
                            </div>
