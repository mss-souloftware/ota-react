...
import g1 from "../../../assets/images/services/inner/video.jpg";
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="about__text__block">
                                <div className="sub__title">
                                    <h4>SKETCH TO SCREEN</h4>
                                </div>
                                <div className="title two">
                                    <h2>
                                        Animating <span>Ideas</span>, Igniting Imagination
                                    </h2>
                                </div>
                                <div className="texts">
                                    <p>
                                        Our video animation services are not just about creating visuals; they're about telling your story in a way that captivates and engages your audience. We take the time to understand your brand, your message, and your audience, and tailor our animations to fit your unique needs and objectives. From 2D animations to 3D renders, from explainer videos to character animations, we offer a wide range of animation styles to suit your project requirements. Whether you're looking for something fun and quirky or sleek and professional, we have the expertise and resources to bring your vision to life.
                                    </p>
                                </div>
                ...
                <div className="auto-container">
                    <div className="row">
                        <div className="col-lg-4 col-md-12">
                            ...
                            <div className="title two">
                                <h2>
                                    Bringing Your <span>Vision to Life</span>, Frame by Frame
                                </h2>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="normaol__text">
                                <p> In today's digital age, video has become a powerful tool for engaging audiences and conveying messages in a memorable and impactful way. At Outsource to Asia, we specialize in creating stunning video animations that captivate viewers and bring your ideas to life.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <Accordion activeKey={activeAccordion} onSelect={handleAccordionChange}>
                                    <Accordion.Item eventKey="1">
                                        <Accordion.Header>
                                            ...
                                            Custom Animation</Accordion.Header>
                                        <Accordion.Body>
                                            Whether you're looking to explain a complex concept, promote a product or service, or tell your brand story, our team of skilled animators will work closely with you to create custom animations that convey your message effectively. From 2D animations to 3D renders, we'll bring your vision to life with creativity and flair.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="2">
                                        <Accordion.Header>
                                            ...
                                            Explainer Videos</Accordion.Header>
                                        <Accordion.Body>
                                            Need to simplify a complex idea or process? Our explainer videos are designed to do just that. Using engaging visuals, clear narration, and compelling storytelling, we'll help you communicate your message in a way that's easy to understand and impossible to ignore.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="3">
                                        <Accordion.Header>
                                            ...
                                            Promotional Videos</Accordion.Header>
                                        <Accordion.Body>
                                            Looking to promote a new product or service? Our promotional videos are designed to grab attention and drive action. Whether you're launching a new product, running a special promotion, or showcasing your brand's unique value proposition, we'll create a video that gets results.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="4">
                                        <Accordion.Header>
                                            ...
                                            Animated Infographics</Accordion.Header>
                                        <Accordion.Body>
                                            Make your data come alive with animated infographics. Our designers will transform boring statistics and charts into dynamic visualizations that engage viewers and make your information more memorable and shareable.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="5">
                                        <Accordion.Header>
                                            ...
                                            Character Animation</Accordion.Header>
                                        <Accordion.Body>
                                            Want to add personality to your videos? Our character animation services are perfect for bringing your brand mascots or animated spokespersons to life. Whether it's a quirky character or a relatable avatar, we'll create animations that resonate with your audience and reinforce your brand identity.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="5">
                                        <Accordion.Header>
                                            ...
                                            Motion Graphics</Accordion.Header>
                                        <Accordion.Body>
                                            Add visual interest to your videos with motion graphics. Whether it's dynamic text animations, kinetic typography, or eye-catching transitions, our motion graphics will elevate your video and make it stand out from the crowd.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                </Accordion>
                            </div>
            ...
            <div className="pride__section  p_relative see__pad">
                ...
                <div className="auto-container">
                    <div className="pride__block">
                        <h1> Unleash the Power of Animated Communication</h1>
                        <p className='mt-20'>Bring your ideas to life with dynamic video animation that engages audiences, tells stories, and makes an impact.</p>
