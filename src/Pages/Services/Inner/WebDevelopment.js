...
import g1 from "../../../assets/images/services/inner/web-dev.jpg";
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="about__text__block">
                                ...
                                <div className="title two">
                                    <h2>
                                        Coding Your <span>Vision</span> into Reality
                                    </h2>
                                </div>
                                <div className="texts">
                                    <p>
                                        Unlock the full potential of your online presence with our Web Development services. In today's digital landscape, a strong and dynamic website is essential for success. Whether you're a startup looking to make your mark or an established enterprise seeking to innovate, our team of experienced developers is here to bring your vision to life.
                                    </p>
                                </div>
                ...
                <div className="auto-container">
                    <div className="row">
                        <div className="col-lg-4 col-md-12">
                            ...
                            <div className="title two">
                                <h2>
                                    Transforming Ideas into <span>Interactive</span> Experiences
                                </h2>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="normaol__text">
                                <p> In today's fast-paced digital world, a strong and dynamic website is essential for success. Whether you're a startup looking to make your mark or an established enterprise seeking to innovate, our team of experienced web developers is here to bring your vision to life.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <Accordion activeKey={activeAccordion} onSelect={handleAccordionChange}>
                                    <Accordion.Item eventKey="1">
                                        <Accordion.Header>
                                            ...
                                            Custom Web Development</Accordion.Header>
                                        <Accordion.Body>
                                            We specialize in creating custom websites tailored to your unique needs and goals. From simple landing pages to complex e-commerce platforms, we'll work closely with you to design and develop a website that reflects your brand identity and delivers an exceptional user experience.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="2">
                                        <Accordion.Header>
                                            ...
                                            Responsive Design</Accordion.Header>
                                        <Accordion.Body>
                                            With mobile usage on the rise, it's more important than ever to ensure that your website looks and performs flawlessly across all devices. Our developers are experts in responsive design, ensuring that your website is accessible and user-friendly on desktops, laptops, tablets, and smartphones alike.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="3">
                                        <Accordion.Header>
                                            ...
                                            Content Management Systems (CMS)</Accordion.Header>
                                        <Accordion.Body>
                                            Take control of your website's content with a powerful CMS. Whether you prefer WordPress, Shopify, or another platform, we'll help you choose the right CMS for your needs and customize it to meet your specific requirements.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="4">
                                        <Accordion.Header>
                                            ...
                                            E-commerce Development</Accordion.Header>
                                        <Accordion.Body>
                                            Ready to take your online store to the next level? Our e-commerce development services are designed to help you create a seamless shopping experience that drives sales and fosters customer loyalty. From product listings and checkout processes to payment gateways and inventory management, we've got you covered.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="5">
                                        <Accordion.Header>
                                            ...
                                            Website Maintenance and Support</Accordion.Header>
                                        <Accordion.Body>
                                            Your website is a dynamic and ever-evolving entity. Our team offers ongoing maintenance and support services to ensure that your website remains secure, up-to-date, and running smoothly at all times.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                </Accordion>
                            </div>
            ...
            <div className="pride__section  p_relative see__pad">
                ...
                <div className="auto-container">
                    <div className="pride__block">
                        <h1>Crafting Seamless User Experiences</h1>
                        <p className='mt-20'>Partner with us to create a web presence that sets you apart and drives results.</p>
                        <div className="btn-box mt-50 mx-auto justify-content-center">
                            <Link to="/about" className="theme-btn theme-btn-one">
                                <i className="icon-02"></i>  Let's Build Something Amazing Together
                            </Link>
                        </div>
                    </div>
                </div>
